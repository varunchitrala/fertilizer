    ...
    >
      <div className="gallery-page-container">
        <ScrollReveal>
          <header className="gallery-page-hero">
            <div className="gallery-page-hero-topline">
              ...
              <span className="gallery-page-hero-status">
                <i /> FIELD ARCHIVE
              </span>
            </div>
            <div className="gallery-page-hero-main">
              <div className="gallery-page-hero-title">
                ...
                <p className="gallery-page-hero-intro">
                  A closer look at the farms, people and agricultural work
                  behind Agripex.
                </p>
                <Link
                  to="#gallery-archive"
              ...
              <div className="gallery-page-hero-visual">
                <div className="gallery-page-hero-image-frame">
                  ...
                  <span className="gallery-page-hero-tag">
                    FIELD STORY / 01
                  </span>
                  <span className="gallery-page-hero-plus" aria-hidden="true">
                    +
                  </span>
                  <div className="gallery-page-hero-scan">
                    <span>AGRIPEX</span>
                    <span>FIELD / 2026</span>
                  </div>
                </div>
                <div className="gallery-page-hero-caption">
                  <span>People. Practice. Progress.</span>
                  <span>01 — 06</span>
                </div>
              </div>
            </div>
            <div className="gallery-page-hero-marquee" aria-hidden="true">
        ...
        <ScrollReveal distance={24} delay={70}>
          <div
            className="gallery-page-toolbar"
            id="gallery-archive"
          ...
          >
            ...
            <span className="gallery-page-count">
              {String(visibleItems.length).padStart(2, "0")} images
            </span>
          </div>
        </ScrollReveal>
