      ...
      <article className="product-card">
        <button className="product-card-open" type="button" onClick={() => onOpen(product, index)} aria-label={`View ${product.name} details`}>
          <div className="product-card-image">
            ...
            <span className="product-card-view">View product <b>↗</b></span>
          </div>
      ...
      <div className="container">
        <header className="products-catalog-header">
          <div className="products-catalog-heading">
            ...
            <h2>Products made for the <em>field.</em></h2>
            <p>Explore the complete Agripex range. Select a product to view its available product information.</p>
          </div>
          <div className="products-catalog-index">
            <strong>25</strong>
            <span>Products<br />in range</span>
          </div>
        </header>

        <div className="products-catalog-bar">
          <span>AGRIPEX PRODUCT RANGE</span>
          <span>Select a product to view details <b>↓</b></span>
        </div>
