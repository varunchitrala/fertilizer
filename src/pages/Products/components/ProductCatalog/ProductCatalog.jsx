      ...
      <article className="product-card">
        ...
        >
          <div className="product-card-image">
            ...
            <span className="product-card-image-arrow" aria-hidden="true">
              ↗
            </span>
          </div>
        </Link>
      ...
      <div className="container">
        <header className="products-catalog-header">
          <div className="products-catalog-heading">
            ...
            <p>
              Explore the complete Agripex product range. Select a product to
              view its complete information on a dedicated product page.
            </p>
          </div>
        ...
        <div className="products-catalog-toolbar">
          ...
          <span>
            25 PRODUCTS <b>·</b> PRODUCT DETAILS
          </span>
        </div>
