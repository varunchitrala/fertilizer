...
const products = {
  "calcium-nitrate": {
    ...
    features: [
      [
        "EA² Technology",
        "Enhanced nutrient uptake and increased efficacy, with improved nutrient translocation and faster results.",
      ],
      [
        "S² Technology",
        "Concentration beyond what is normally achievable in liquid formulations, with improved nutrient translocation and faster results.",
      ],
      [
        "High Quality Raw Materials",
        "Designed around quality raw materials to support maximum efficacy and safety.",
      ],
      ...
      [
        "Enhanced Mix Profile",
        "Facilitates combined application for reduced application cost.",
      ],
      [
        "Stability",
        "Certified manufacturing processes and testing support a long shelf life.",
      ],
    ],
...
function ProductDetail() {
  ...
  const handleWhatsAppEnquiry = (event) => {
    ...
    const message = encodeURIComponent(
      `Hello Agripex, I would like to enquire about ${product.name}. Quantity: ${quantity}. Requirement: ${
        requirement.trim() || "Please share product details and pricing."
      }`,
    );

    window.open(
      `https://wa.me/917770047272?text=${message}`,
      "_blank",
      "noopener,noreferrer",
    );
  };
      ...
      <>
        ...
        <main className="product-detail-page product-not-found">
          <div className="container">
            ...
            <h1>This product page is not available yet.</h1>
      ...
      <main className="product-detail-page">
        <div className="container">
          ...
          <div className="product-detail-hero">
            <ScrollReveal className="product-detail-visual" distance={30}>
              <div className="product-detail-image">
                <img src={product.image} alt={product.name} />
                <span>AGRIPEX / PRODUCT</span>
              </div>
            </ScrollReveal>
            <ScrollReveal
            ...
            >
              ...
              <div className="product-detail-meta-line">
                <span>AGRIPEX</span>
                <span>PRODUCT INFORMATION</span>
              </div>
            </ScrollReveal>
          </div>
          <section className="product-detail-section product-overview">
            <span className="product-detail-label">01 / Product overview</span>
            <h2>
              Designed around <em>practical crop needs.</em>
            </h2>
            <p>{product.overview}</p>
          </section>
          <section className="product-detail-section">
            <span className="product-detail-label">02 / Key features</span>
            <div className="product-feature-list">
              {product.features.map(([title, text], i) => (
          ...
          <section className="product-detail-section">
            <span className="product-detail-label">03 / Application guide</span>
            <div className="product-guide-grid">
              <div>
                <h3>Application</h3>
                <div className="product-tags">
                  {product.application.map((x) => (
                    <b key={x}>{x}</b>
                  ))}
                </div>
              </div>
          ...
          <section className="product-detail-section">
            <span className="product-detail-label">04 / Specifications</span>
          ...
          >
            <div className="product-detail-enquiry-copy">
              <span>Need product information?</span>
              <h2>Talk to the Agripex team.</h2>
            </div>

            <div className="product-detail-enquiry-form">
              <label>
                <span>Quantity</span>
                <input
                  type="text"
              ...
              <label>
                ...
                <textarea
                  ...
                  placeholder="Tell us the crop, usage, location, and any other requirement"
                  rows="3"
                />
              </label>
