      ...
      <div className="header-container hero-content">
        ...
        <div className="hero-bottom">
          ...
          <div className="hero-controls" aria-label="Hero carousel controls">
            <button type="button" className="hero-control" onClick={previousSlide} aria-label="Previous slide">
              <span>←</span>
            </button>
            <button type="button" className="hero-control" onClick={nextSlide} aria-label="Next slide">
              <span>→</span>
            </button>
          </div>
        </div>
