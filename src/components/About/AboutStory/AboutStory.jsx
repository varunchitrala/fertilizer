    ...
    <section className="about-story" id="about-story">
      <div className="header-container about-story-grid">
        ...
        <ScrollReveal className="about-story-copy" delay={120} distance="up">
          ...
          <p>AGRIPEX PESTICIDE FERTILIZER AND CHEMICAL PRIVATE LIMITED is a trusted name in the agriculture sector, committed to providing high-quality pesticides, fertilizers, and agricultural chemicals.</p>
          <p>We support farmers with reliable products that enhance crop health, productivity, and yield, while contributing to sustainable and profitable farming practices across India.</p>
        </ScrollReveal>
